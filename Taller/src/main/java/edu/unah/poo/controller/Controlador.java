...
public class Controlador {
		...
		//METODO PARA PODER ACCEDER A PAGINA WEB
		@GetMapping("/mecanico/registrar")
		...
		public String detallesMecanico(@PathVariable("id") int id, Model model) {
		...
		public String crearMecanico(@RequestParam(name = "id") int idMecanico,
